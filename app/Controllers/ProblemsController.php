...
class ProblemsController extends Controller
{
    ...
    public function show(Request $request): void
    {
        ...
        $problem = $this->current_teacher->problems()->findById($params['id']);
    ...
    {
        $problem = $this->current_teacher->problems()->new();
    ...
    {
        $params = $request->getParams();
        $problem = $this->current_teacher->problems()->new($params['problem']);
    ...
    public function update(Request $request): void
    {
        ...
        $problem = $this->current_teacher->problems()->findById($id);
